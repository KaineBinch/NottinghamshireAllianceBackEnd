...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    eventReview: Schema.Attribute.Text;
    ...
    >;
    golf_club: Schema.Attribute.Relation<
      'manyToOne',
      'api::golf-club.golf-club'
    >;
    golfers: Schema.Attribute.Relation<'manyToMany', 'api::golfer.golfer'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::event.event'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    scores: Schema.Attribute.Relation<'oneToMany', 'api::score.score'>;
    tee_times: Schema.Attribute.Relation<'oneToMany', 'api::tee-time.tee-time'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiGolfClubGolfClub extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    clubContactNumber: Schema.Attribute.String;
    clubID: Schema.Attribute.Enumeration<
      [
        'BF',
        'BON',
        'BRI',
    ...
    >;
    clubImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    clubLogo: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    ...
    golfers: Schema.Attribute.Relation<'oneToMany', 'api::golfer.golfer'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::golf-club.golf-club'
    > &
      Schema.Attribute.Private;
    proName: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiGolferGolfer extends Struct.CollectionTypeSchema {
  collectionName: 'golfers';
  info: {
    description: '';
    displayName: 'Golfer';
    pluralName: 'golfers';
  ...
  attributes: {
    ...
    golf_club: Schema.Attribute.Relation<
      ...
      'api::golf-club.golf-club'
    >;
    golferName: Schema.Attribute.String;
    isPro: Schema.Attribute.Boolean;
    isSenior: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::golfer.golfer'
    ...
    publishedAt: Schema.Attribute.DateTime;
    scores: Schema.Attribute.Relation<'oneToMany', 'api::score.score'>;
    tee_times: Schema.Attribute.Relation<
      'manyToMany',
      'api::tee-time.tee-time'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiScoreScore extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    golfer: Schema.Attribute.Relation<'manyToOne', 'api::golfer.golfer'>;
    golferEventScore: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiTeeTimeTeeTime extends Struct.CollectionTypeSchema {
  collectionName: 'tee_times';
  info: {
    description: '';
    displayName: 'Tee Time';
    pluralName: 'tee-times';
  ...
  attributes: {
    ...
    event: Schema.Attribute.Relation<'manyToOne', 'api::event.event'>;
    golfers: Schema.Attribute.Relation<'manyToMany', 'api::golfer.golfer'>;
    golferTeeTime: Schema.Attribute.Time;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::tee-time.tee-time'
